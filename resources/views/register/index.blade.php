    ...
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <main class="form-registration">
                ...
                {{-- method get untuk menampilkan form, method post dijalankan jika semuanya sudha selesai --}}
                <form action="/register" method="POST">
                    ...
                    <div class="form-floating">
                        <input type="password" class="form-control rounded-bottom @error('email') is-invalid @enderror"
